...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="#">进货信息列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="pmsPurchasesInfo" action="${ctx}/pmswarehouseinfo/pmsWarehouseInfo/Warehousedetailslist" method="post" class="breadcrumb form-search">
